...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="h-14 border-b border-border bg-panelSub/95 backdrop-blur px-3 sm:px-4 flex items-center justify-between z-30 select-none shadow-sm relative">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        >
          ...
          <div>
            <h1 className="text-xs sm:text-sm font-bold text-zinc-100 leading-tight">
      ...
      {showComplianceModal &&
        createPortal(
          <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/75 backdrop-blur-md p-4 animate-in fade-in duration-200">
            <div className="bg-[#18191e] border border-zinc-700 rounded-xl max-w-lg w-full p-5 sm:p-6 shadow-2xl relative text-left">
