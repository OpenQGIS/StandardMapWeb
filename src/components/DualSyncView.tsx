        ...
        {hoverNormalizedPos && (
          ...
          >
            <Crosshair
              fill="none"
              strokeWidth={2.5}
              className="w-5 h-5 text-emerald-500 dark:text-emerald-400 fill-none [&_*]:fill-none stroke-current"
            />
          </div>
        )}
      </div>
        ...
        {hoverNormalizedPos && (
          ...
          >
            <Crosshair
              fill="none"
              strokeWidth={2.5}
              className="w-5 h-5 text-amber-500 dark:text-amber-400 fill-none [&_*]:fill-none stroke-current"
            />
          </div>
        )}
      </div>
